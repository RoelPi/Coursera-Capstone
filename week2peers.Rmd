...
It has become clear that the average word count for each of the data types (tweet, blog, news) is different. If we want to answer inferential questions that requires hypothesis tests that are based on normality, we will have to transform the data.